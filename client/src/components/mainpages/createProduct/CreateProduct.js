        ...
        <div className="create_product">
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className="row">
                    ...
                    placeholder={product.description} rows="4" onChange={handleChangeInput} />
                </div>

                <div className="row">
                    <label htmlFor="size">Размер</label>
                    <input type="text" name="size" id="size" required
                    placeholder={product.size} onChange={handleChangeInput} />
                </div>
                ...
                <button type="submit">{onEdit? "Сохранить" : "Создать"}</button>
            </form>
        </div>
    )
}
